    ...
    <form wire:submit="save">
        <div class="mb-6">
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <flux:textarea wire:model="VILLAGEROFTHEYEAR_RECEIVERS" label="Ontvangers" /> <em>Ook versturen naar
                        de zender? Gebruik:
                        ##ZENDER##</em>
                </div>
                <div>
                    <ul class="list-disc pl-5">
                        @foreach (explode(PHP_EOL, $VILLAGEROFTHEYEAR_RECEIVERS) as $key => $value)
